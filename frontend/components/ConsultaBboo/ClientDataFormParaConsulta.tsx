...
import DomicilioSelectionModal from '../salesForm/common/DomicilioSelectionModal';
import { getTiposDocumento, getClientes, getServiciosConvergentes, getBarrios } from '../../services/api';
import { TipoDocumento as TipoDocOption, Cliente, ClientDataState, ClientSearchFilters, Domicilio, Barrio, SelectOption, ClientDataStateErrors, PaginationInfo } from '../../types';
        ...
        <Card className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Select label="Tipo de Documento" id="tipoDocumento" options={tiposDocumento.map(td => ({ id: td.id.toString(), descripcion: td.descripcion, activo: td.activo }))} value={data.tipoDocumentoId}
                    ...
                    }} emptyOptionLabel="Seleccione tipo" />
                ...
                <Input label="Teléfono de contacto principal" id="telPrincipal" type="tel" value={data.telefono_principal}
                    ...
                    placeholder="Número principal" className="flex-grow" error={errors.telefono_principal} />
