    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 bg-gray-900 text-gray-300 min-h-screen">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold text-white mb-6">Gestión de Abonos</h1>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-700">
                                    ...
                                    <tbody className="bg-gray-800 divide-y divide-gray-700">
                                        {abonos.map((abono) => (
                                            <tr key={abono.id} className="hover:bg-gray-700/50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <Button onClick={() => handleEditClick(abono)} variant="primary" className="flex items-center gap-1">
                                                        <Edit size={16} />
                                                        <span>Editar</span>
                                                    </Button>
                                                </td>
