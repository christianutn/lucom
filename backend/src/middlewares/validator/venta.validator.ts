...
export const validarCreacionVenta = (): (ValidationChain | ((req: any, res: any, next: any) => void))[] => [
    ...
    // Validaciones para cliente, domicilio y barrio, aplicadas condicionalmente.
    // Solo se ejecutan si el tipo de negocio NO es BBOO.
    // ...[
    //     ...validarAtributosCliente,
    //     ...validarAtributosDomicilio,
    //     ...validarAtributosBarrio
    // ].map(validation => validation.if(body('datosVenta.tipo_negocio_id').not().equals(STRATEGY_IDS.BBOO))),
    ...validarAtributosCliente,
    ...validarAtributosDomicilio,
    ...validarAtributosBarrio,
